    ...
    <div className="flex w-full flex-wrap justify-evenly gap-y-7">
      {data.map((i) => (
        <div
          key={i}
          role="status"
          className="lg:w-[23%] md:w-[32%] w-[90%] p-4 border-2 border-gray-300 rounded shadow animate-pulse md:p-6 dark:border-gray-700"
        >
          <div className="flex items-center justify-center h-48 mb-4 border-4 border-gray-300 rounded dark:bg-gray-700">
            <svg
